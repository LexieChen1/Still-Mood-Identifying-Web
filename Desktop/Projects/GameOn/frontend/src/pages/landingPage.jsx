...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-cover bg-center bg-no-repeat bg-[url('/assets/background.jpg')] text-center flex flex-col justify-between font-sans">
      ...
      <p className="text-2xl font-sans text-forest mb-3">YOUR NEW FINANCIAL AGENT</p>
      {/* main statement with highlights*/}
      <p className="text-7xl font-mono font-black text-black mb-2">
        Smart split
      </p>
      ...
      <p className="text-7xl font-mono font-black text-black mb-2">
        ...
        <span className="relative inline-block">
          ...
          {/* text on bottom */}
          <span className="relative z-10 px-4 py-1">smart trips</span>
        </span>
      </p>

      <p className="text-grey max-w-xs mx-auto mt-4">
